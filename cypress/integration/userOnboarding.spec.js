...
describe('Form Validation', () => {
    ...
    it('Trigger name validation error', () => {
        ...
        cy.get('input[name="name"]').clear()
            .type('w?uk3Dtr:]4UV))\@ck$^Hd$zJyeJ__W(pXtJ&HsY<4bUv;Jx^dgB}*Sy[N8*HcTMR"+e\=4*PV')
        cy.get('.errors')
    ...
    it('Trigger email validation error', () => {
        ...
        cy.get('input[name="email"]').clear()
            .type('sam@some-email.commmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm')
            .should('have.value','sam@some-email.commmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm')
        cy.get('.errors')
            .contains('Too many characters')
        cy.get('input[name="email"]').clear()
    ...
    it('Trigger password validation error', () => {
        ...
        cy.get('input[name="password"]').clear()
            .type('w?uk3Dtr:]4UV))\@ck$^Hd$zJyeJ__W(pXtJ&HsY<4bUv;Jx^dgB}*Sy[N8*HcTMR"+e\=4*PV')
        cy.get('.errors')
            .contains('Are you really going to remember that password?')
        cy.get('input[name="password"]').clear()
            .type('Passw0rd?')
            .should('have.value', 'Passw0rd?')
        cy.get('.errors')
